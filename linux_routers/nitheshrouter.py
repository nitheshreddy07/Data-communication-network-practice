...
class NetworkTopo( Topo ):
    ...
    def build( self, **_opts ):
        ...
        h4 = self.addHost( 'h4', ip='192.168.1.100/24',
                           defaultRoute='via 192.168.1.1' ) 
        h5 = self.addHost( 'h5', ip='172.16.0.100/12',
                           defaultRoute='via 172.16.0.1' ) 
        h6 = self.addHost( 'h6', ip='10.0.0.100/8',
                           defaultRoute='via 10.0.0.1' )                                                       

        for h, s in [ (h1, s1), (h2, s2), (h3, s3), (h4, s4), (h5, s5), (h6, s6), (s1, s4), (s3, s6), (s2, s5) ]:
            self.addLink( h, s )
